...
public class ISGCaseCreationHomePage {
	...
	public boolean hasCaseInformationSectionDisplayed() {
		CommonFunctions.scrollToElement(driver, caseInfrom);
		return CommonFunctions.isElementExist(driver, caseInfrom);
	}
	...
	public ISGCaseCreationHomePage clickEyeBtn() {
		CommonFunctions.isElementExist(driver, caseCretionEyeIcon);
	...
	public boolean hasCreatedOnDisplayed() {
		return CommonFunctions.isElementExist(driver, createdOn);
	}

	public boolean hasLastAssignedDisplayed() {
		return CommonFunctions.isElementExist(driver, lastAssigned);
	}

	public boolean hasLastModifiedDisplayed() {
		return CommonFunctions.isElementExist(driver, lastModified);
	}
	...
	public boolean hasProductHeadingDisplayed() {
		return CommonFunctions.isElementExist(driver, prodHeading);
	}
	...
	public boolean hasProductInfDisplayed() {
		return CommonFunctions.isElementExist(driver, prodInfm);
	}
